...
public class KMJCardSimApplet extends KMKeymasterApplet {
  ...
  private static final byte INS_PROVISION_ATTEST_IDS_CMD =
      INS_KEYMINT_PROVIDER_APDU_START + 3; //0x03
  private static final byte INS_PROVISION_PRESHARED_SECRET_CMD =
      INS_KEYMINT_PROVIDER_APDU_START + 4; //0x04
  private static final byte INS_SET_BOOT_PARAMS_CMD = INS_KEYMINT_PROVIDER_APDU_START + 5; //0x05
  private static final byte INS_LOCK_PROVISIONING_CMD = INS_KEYMINT_PROVIDER_APDU_START + 6; //0x06
  private static final byte INS_GET_PROVISION_STATUS_CMD =
      INS_KEYMINT_PROVIDER_APDU_START + 7; //0x07
  ...
  KMJCardSimApplet() {
    super(new KMJCardSimulator(), kmSpecification);
  }
  ...
  public static void install(byte[] bArray, short bOffset, byte bLength) {
    kmSpecification = bArray[(short) (bOffset + 1)];
