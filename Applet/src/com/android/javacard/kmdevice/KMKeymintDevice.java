...
public class KMKeymintDevice extends KMKeymasterDevice {
  ...
  public KMKeymintDevice(KMSEProvider seImpl, KMRepository repoInst,  KMEncoder encoderInst, KMDecoder decoderInst, KMDataStore storeData,
  ...
  public static void initStatics() {
    JAVACARD_KEYMINT_DEVICE = new byte[] { 0x4a, 0x61, 0x76, 0x61, 0x63, 0x61, 0x72, 0x64, 0x4b, 0x65, 0x79, 0x6d, 0x69,
        0x6e, 0x74, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, };
    GOOGLE = new byte[] { 0x47, 0x6F, 0x6F, 0x67, 0x6C, 0x65 };
    dec319999Ms = new byte[] { (byte) 0, (byte) 0, (byte) 0xE6, (byte) 0x77, (byte) 0xD2, (byte) 0x1F, (byte) 0xD8,
        (byte) 0x18 };
    dec319999 = new byte[] { 0x39, 0x39, 0x39, 0x39, 0x31, 0x32, 0x33, 0x31, 0x32, 0x33, 0x35, 0x39, 0x35, 0x39,
        0x5a, };
    jan01970 = new byte[] { 0x37, 0x30, 0x30, 0x31, 0x30, 0x31, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x5a, };
  }
  ...
  public short getHardwareInfo() {
    ...
    KMArray.add(respPtr, (short) 3,
        KMByteBlob.instance(JAVACARD_KEYMINT_DEVICE, (short) 0, (short) JAVACARD_KEYMINT_DEVICE.length));
  ...
  @Override
  public short makeKeyCharacteristics(short keyParams, short osVersion, short osPatch, short vendorPatch,
      short bootPatch, short origin, byte[] scratchPad) {
    short strongboxParams = KMKeyParameters.makeSbEnforced(keyParams, (byte) origin, osVersion, osPatch, vendorPatch,
  ...
  @Override
  public short concatParamsForAuthData(short keyBlobPtr, short hwParams, short swParams, short hiddenParams,
      short pubKey) {
    short arrayLen = 2;
  ...
  @Override
  public KMAttestationCert makeCommonCert(short swParams, short hwParams, short keyParams, byte[] scratchPad,
    ...
    if (KMInteger.compare(notBefore, epoch) == 0) {
      cert.notBefore(KMByteBlob.instance(jan01970, (short) 0, (short) jan01970.length), true, scratchPad);
    } else {
      cert.notBefore(notBefore, false, scratchPad);
    }
    // VTS sends notAfter == Dec 31st 9999
    if (KMInteger.compare(notAfter, end) == 0) {
      cert.notAfter(KMByteBlob.instance(dec319999, (short) 0, (short) dec319999.length), true, scratchPad);
    } else {
      cert.notAfter(notAfter, false, scratchPad);
    }
    // Serial number
    short serialNum = KMKeyParameters.findTag(keyParams, KMType.BIGNUM_TAG, KMType.CERTIFICATE_SERIAL_NUM);
  ...
  public short getMgf1Digest(short keyParams, short hwParams) {
    short mgfDigest = KMKeyParameters.findTag(keyParams, KMType.ENUM_ARRAY_TAG, KMType.RSA_OAEP_MGF_DIGEST);
  ...
  public void beginKeyAgreementOperation(KMOperationState op) {
    ...
    op.setOperation(seProvider.initAsymmetricOperation((byte) op.getPurpose(), (byte) op.getAlgorithm(),
        ...
        KMByteBlob.getBuffer(data[SECRET]), KMByteBlob.getStartOff(data[SECRET]), KMByteBlob.length(data[SECRET]), null,
        (short) 0, (short) 0));
  }
  ...
  @Override
  public void getAttestKeyInputParameters(short arrPtr, short[] data, byte keyBlobOff, byte keyParametersOff,
  ...
  @Override
  public short prepareBeginResp(short paramsPtr, short opHandlePtr, short bufModePtr, short macLengthPtr) {
  ...
  @Override
  public void getUpdateInputParameters(short arrPtr, short[] data, byte opHandleOff, byte keyParametersOff,
  ...
  @Override
  public void getFinishInputParameters(short arrPtr, short[] data, byte opHandleOff, byte keyParametersOff,
  ...
  public void validatePurpose(short params) {
    ...
    if (attKeyPurpose != KMType.INVALID_VALUE && KMEnumArrayTag.contains(attKeyPurpose, KMType.ATTEST_KEY)
  ...
  public short generateBcc(boolean testMode, byte[] scratchPad) {
    ...
    short coseSignStructure = kmCoseInst.constructCoseSignStructure(protectedHeader, KMByteBlob.instance((short) 0),
        payload);
    ...
    short coseSign1 = kmCoseInst.constructCoseSign1(protectedHeader, unprotectedHeader, payload, coseSignStructure);
