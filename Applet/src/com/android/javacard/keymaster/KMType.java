...
public abstract class KMType {
  ...
  protected static short copyToUint32(byte[] src, short srcOff, short srcLen, byte[] dest, short destOff) {
    if (srcLen > KMInteger.UINT_32) {
      ISOException.throwIt(ISO7816.SW_DATA_INVALID);
    }
    Util.arrayFillNonAtomic(dest, destOff, KMInteger.UINT_32, (byte) 0);
    Util.arrayCopyNonAtomic(src, srcOff, dest, (short) (destOff + KMInteger.UINT_32 - srcLen), srcLen);
