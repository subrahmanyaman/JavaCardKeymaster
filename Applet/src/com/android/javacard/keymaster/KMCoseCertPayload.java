...
/**
 * KMCoseCertPayload represents the COSE_Sign1 payload for each certificate in Dice cert chain. The
 * supported key types are KMInteger, KMNInteger and the supported value types are KMByteBlob and
